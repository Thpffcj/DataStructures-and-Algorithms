...
public class MineSweeperData {
    ...
    public static final String blockImageURL = "src/algorithms/algorithmicGame/mineSweeper/resources/block.png";
    public static final String flagImageURL = "src/algorithms/algorithmicGame/mineSweeper/resources/flag.png";
    public static final String mineImageURL = "src/algorithms/algorithmicGame/mineSweeper/resources/mine.png";

    public static String numberImageURL(int num){
        if(num < 0 || num >= 8) {
            throw new IllegalArgumentException("No such a number image!");
        }
        return "src/algorithms/algorithmicGame/mineSweeper/resources/" + num + ".png";
    }
